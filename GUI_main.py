...
#
label_l1 = tk.Label(root, text="Plant Leaf Disease Detection",font=("Times New Roman", 30, 'bold'),
...
button1 = tk.Button(root, text="Registration",command=reg,width=17, height=1,font=('times', 20, ' bold '), bg="maroon", fg="white")
button1.place(x=100, y=160)

button2 = tk.Button(root, text="Login", command=log, width=17, height=1,font=('times', 20, ' bold '), bg="maroon", fg="white")
